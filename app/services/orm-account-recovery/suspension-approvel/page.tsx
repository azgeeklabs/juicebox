  ...
  return (
    <NextPrevNav
      ...
      nextLink={
        suspended
          ? undefined
          : "/services/orm-account-recovery/suspension-approvel/"
      }
      nextText={suspended ? "All Done" : undefined}
      nextOnClick={
        suspended
          ? () => {
              setSuspension(true);
        ...
        <div className={`${styles.addLinkEdit} w-full`}>
          {suspended ? (
            <h2 className="text-center">
              We are sorry, but we are unable to assist you with accounts banned
              for this reason
            </h2>
          ) : (
            <>
              ...
              >
                ...
                <h4 className="text-center">
                  Upload a screenshot of the message you received when your
