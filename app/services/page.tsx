...
<section>
    ...
    <div className={styles.searchAndFilter + " flex justify-between items-center gap-[0.75vw]"}>
      

      <div className="relative w-[92%]">
    <input type="search" placeholder="Search" className="w-full"/>
    <svg className="absolute top-1/2 transform -translate-y-1/2" width="17" height="17" viewBox="0 0 17 17" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <span className={isAdvancedFilterActive ? styles.active : ""}
      onClick={() => setIsAdvancedFilterActive(!isAdvancedFilterActive)}
