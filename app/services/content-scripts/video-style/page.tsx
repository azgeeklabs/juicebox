...
const page = () => {
  return (
    ...
    <NextPrevNav nextLink="/services/content-scripts/kind-of-video" backLink="/services/content-scripts/channel-choice"><div className=" h-full flex items-center justify-center">
    ...
    <div className={`${styles.videoStyle} w-full`}>
      ...
      <div className="text-center mx-auto mb-[4.037vh]">
        ...
        <h4>
          ...
          let our creative juices <hr className="border-0" /> flow to create
