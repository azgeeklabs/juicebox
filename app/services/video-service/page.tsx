      ...
      <div className={`${styles.editing} w-full `}>
        ...
        <div className=" flex items-center justify-between pl-[4.021vw] pr-[1vw]">
          <div className={`${styles.btns} flex flex-col gap-[1.041vw]`}>
            <CustomCheckBoxText btnSize="xl" inputType="checkbox">Explainer</CustomCheckBoxText>
            <CustomCheckBoxText btnSize="xl" inputType="checkbox">Educational</CustomCheckBoxText>
            <CustomCheckBoxText btnSize="xl" inputType="checkbox">YouTube</CustomCheckBoxText>
            <CustomCheckBoxText btnSize="xl" inputType="checkbox">Social Media Ad</CustomCheckBoxText>
            <CustomCheckBoxText btnSize="xl" inputType="checkbox">Short Film</CustomCheckBoxText>
          </div>
          <div>
