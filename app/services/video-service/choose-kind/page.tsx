...
export default function page() {
  ...
  return (
    ...
    <NextPrevNav nextLink="/services/video-service/channel-style" backLink="/services/video-service/video-style"><div className="flex items-center justify-center h-full w-full">
