    ...
    <div className=" flex flex-col justify-between h-full">
      <div className={`${styles.chooseKind} w-full `}>
        <div className=" pt-[1.5vw] pl-[4.264vw] mb-[1.5vw]">
          ...
          What kind of video do you want to be published <hr className="border-0" /> on your channel? 
          </h2>
          <h4>
          we have a variety of video styles, pick the one you think would complement <hr className="border-0" /> the video style you want!</h4>
        </div>
