...
const page = () => {
  ...
  return (
    // Main container div
    <NextPrevNav nextLink={answer == "Create" ? "/services/social-media/creation-frequency" : answer == "Audience" ? "/services/social-media/audience-frequency" : answer == "Post" ? "/services/social-media/post-frequency" : "#"} backLink="/services/social-media">
