...
const page = () => {
  return (
    <NextPrevNav
      nextLink="/services/influencer-marketing/promo-options"
      backLink="/services/influencer-marketing/promo-options"
    >
      <div className=" flex justify-center items-center h-full w-full">
        <div className={`${styles.campaignBudget} w-full`}>
          ...
          <div className="text-center mx-auto mb-[5.333vh]">
            ...
            <h4>
            Select the required budget range you would like.
            </h4>
          </div>
