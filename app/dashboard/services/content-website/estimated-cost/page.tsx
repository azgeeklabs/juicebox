...
const Page = () => {
  ...
  const contentWebsiteRoute = useSelector(
    (state: RootState) => state.contentWebsite.contentWebsiteRoute
  );
    ...
    try {
      const data = await axios.post(
        `${process.env.NEXT_PUBLIC_API_URL}/api/v1/services/initialize-service`,
        {
          ...
          totalSteps: contentWebsiteRoute == "haveWebsite" ? 8 : 9,
  ...
  return (
    ...
    <NextPrevNav
      ...
      nextFunc={nextFunc}
      nextText="All Done"
      backLink="/dashboard/services/content-website/sections-number"
    >
