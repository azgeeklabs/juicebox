...
const Page = () => {
  ...
  const contentWebsiteRoute = useSelector((state:RootState)=>state.contentWebsite.contentWebsiteRoute)
  ...
  async function makeService() {
    ...
    try {
      const data = await axios.post(`https://api.creativejuicebox.com/api/v1/services/initialize-service`,{
        ...
        totalSteps:contentWebsiteRoute == "haveWebsite" ? 9: 10,
  ...
  return (
    ...
    <NextPrevNav nextLink="/dashboard/services" nextFunc={nextFunc} nextText="All Done" backLink="/dashboard/services/content-website/sections-number">
