...
const all = useSelector((state:RootState)=>state.service)
  ...
  const nextFunc = () => {
    ...
    if (document.querySelector("input[type='radio']:checked")) {
      itemsArray.push({
        name: "What kind of video do you want to be published",
        choice: (
      ...
      route.push("/dashboard/services/video-service/channel-style");
    }
  };
useEffect(()=>{
console.log(all);
  ...
  return (
    ...
    <NextPrevNav
      nextLink="/dashboard/services/video-service/channel-style" nextFunc={()=>nextFunc()}
