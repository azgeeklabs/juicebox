...
const page = () => {
  return (
    ...
    <NextPrevNav nextLink="/dashboard/services/video-service/video-style" backLink="/dashboard/services/video-service/advertising"><div className="  h-full flex justify-center items-center">
