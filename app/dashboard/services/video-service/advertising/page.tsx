  ...
  <div className={`${styles.advertising} w-full`}>
    ...
    <div className="mx-auto w-fit">
      ...
      <input
        ...
        className="mb-[2.133vh] w-[19.773vw] bg-[var(--dark-gray-3)] outline-none rounded-[var(--71px)] px-[1.088vw] py-[0.889vh] placeholder:text-[#FFFFFF80]"
      />
      ...
      <div className="flex gap-[1vw] items-start mb-[2.133vh]">
        ...
        <input
          type="text"
          placeholder="Product Name"
          className="h-full mb-[1.778vh] w-[19.773vw] bg-[var(--dark-gray-3)] outline-none rounded-[var(--71px)] px-[1.088vw] py-[0.889vh] placeholder:text-[#FFFFFF80]"
        />
