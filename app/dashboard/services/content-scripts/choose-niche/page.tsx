...
<NextPrevNav nextLink="/services/content-scripts/duration-of-video" backLink="/services/content-scripts/product-advertising" >
    {/* Main container for the content, styled using Tailwind CSS and custom styles */}
    <div className={`${styles.niche} w-full h-full flex justify-center items-center`}>
        <div>
