...
const page = () => {
  return (
    ...
    <NextPrevNav
      nextLink="/dashboard/services/content-scripts/estimated-cost"
      backLink="/dashboard/services/content-scripts/choose-niche"
    >
      {/* Main container for the content, styled using Tailwind CSS and custom styles */}
      <div
        className={`${styles.durationVideo} w-full h-full flex justify-center items-center`}
      >
