...
const Page = () => {
  ...
  const contentBlogRoute = useSelector(
    (state: RootState) => state.contentBlog.contentBlogRoute
  );
  ...
  async function makeService() {
    ...
    console.log({
      type: "content blog",
      totalSteps: contentBlogRoute == "haveWebsite" ? 5 : 4,
          ...
          <div className=" mb-[--sy-40px]">
            ...
            <div className="text-center mx-auto mb-[2.271vw]">
              ...
              <h2 className="mb-[1.5vw] w-[55%] mx-auto">
                ...
                this service is <span>${serviceData?.data?.data?.totalPrice}</span> and would take around{" "}
                <span>{serviceData?.data?.data?.estimatedDuration} Days</span> to finish.
              </h2>
            </div>
