...
const Page = () => {
  ...
  const nextFunc = () => {
    ...
    if (haveWordCount && num > 0) {
      ...
      route.push("/dashboard/services/content-blog/reference-sources");
    } else if (
      !haveWordCount &&
          ...
          <div className={` w-full`}>
            ...
            <div className="text-center mx-auto mb-[4.197271773347325vh]">
              ...
              <p className=" text-[--18px] text-[#FFFFFFCC]">
                Let us know if you have a specific word count in mind for your
                content.
              </p>
            </div>
            <div
            ...
            <div className=" w-[50%] mx-auto">
              <h3 className=" mb-[--sy-18px] text-[--20px] font-semibold">
                Word per Page
              </h3>
